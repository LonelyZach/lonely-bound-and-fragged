...
namespace Prototype.NetworkLobby
{
  ...
  public class LobbyPlayer : NetworkLobbyPlayer
  {
    ...
    public override void OnClientEnterLobby()
    {
      ...
      LobbyPlayerList._instance.DisplayOddPlayerWarning(isServer && numPlayers % 2 == 1 && numPlayers >= 4 );
      LobbyPlayerList._instance.DisplayMinPlayerWarning(isServer && numPlayers < 4);
...
nameInput.characterLimit = MAX_CHARACTER_LIMIT;
    ...
    {
      LobbyPlayerList._instance.RemovePlayer(this, isBeingDestroyed: true);
      if (LobbyManager.s_Singleton != null) LobbyManager.s_Singleton.OnPlayersNumberModified(-1);
